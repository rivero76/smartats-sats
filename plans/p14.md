<!-- Status: IN PROGRESS (branch: p14)
     Stories 1–3 schema + edge functions: implemented
     Story 4 UI: implemented
     BLOCKED: Railway deploy of linkedin scraper (see docs/bugs/bug-railway-up-path-as-root-timeout.md)
     Last commit: 196615d — fix(p14): replace scrollPage evaluate loop
     Remaining: create scripts/playwright-linkedin/.railwayignore and deploy
-->
