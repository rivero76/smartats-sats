<!-- Status: COMPLETED
     ...
     All 3 stories delivered: sats_learning_roadmaps schema + RLS,
     generate-upskill-roadmap edge function, UpskillingRoadmap UI + progress bar.
-->

This is the exact feature that transitions your product from a diagnostic tool into a true career coach. By persisting these roadmaps in the database, you also create a massive retention loop—users will keep coming back to your app to check off their progress.
