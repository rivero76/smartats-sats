...
DROP POLICY IF EXISTS "Users can insert companies for their job descriptions" ON public.sats_companies;
...
DROP POLICY IF EXISTS "Users can insert locations for their job descriptions" ON public.sats_locations;
...
DROP POLICY IF EXISTS "Users can view skills they interact with" ON public.sats_skills;
