...
DO $$
BEGIN
  IF to_regclass('public.sats_companies') IS NOT NULL THEN
...
DO $$
BEGIN
  IF to_regclass('public.sats_locations') IS NOT NULL THEN
...
BEGIN
  IF to_regclass('public.sats_users_public') IS NOT NULL THEN
    ...
    DROP TRIGGER IF EXISTS sats_update_sats_users_public_updated_at ON public.sats_users_public;
