...
PATTERN='(sbp_[A-Za-z0-9_]{10,}|sb_secret_[A-Za-z0-9_]{10,}|service_role[[:space:]]*=|SUPABASE_SERVICE_ROLE_KEY[[:space:]]*=|OPENAI_API_KEY[[:space:]]*=|sk-[A-Za-z0-9_-]{20,}|AKIA[0-9A-Z]{16})'
