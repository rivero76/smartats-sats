...
export const helpContentData: Record<string, HelpContent> = {
  dashboard: {
    ...
    overview: "Your dashboard provides a centralized view of all your recruitment activities, including resumes, job descriptions, and analysis results. Use it to quickly access key features and monitor your progress.",
    keyFeatures: [
    ...
    steps: [
      {
        ...
        description: "Check the statistics cards at the top to see your total resumes, job descriptions, analyses, and average match rate.",
      ...
      },
      {
        ...
        description: "Click on any Quick Action button to jump directly to that feature - Manage Resumes, Job Descriptions, or ATS Analysis.",
        tip: "Start with uploading a resume if you're new, then create job descriptions for analysis."
      },
      {
        step: 3,
        title: "Monitor Recent Activity",
        description: "Check the Recent Activity panel to see your latest analyses and system updates.",
    ...
    troubleshooting: [
      {
        ...
        solution: "This is normal for new accounts. Upload your first resume or create a job description to see data."
      },
      {
        problem: "Quick action buttons not working",
        solution: "Ensure you're logged in and try refreshing the page. Contact support if the issue persists."
      }
    ],
  ...
  resumes: {
    ...
    overview: "The Resume Management section allows you to upload, store, and organize multiple versions of your resume. You can upload files or paste text directly, making it easy to maintain different resumes for different job applications.",
    keyFeatures: [
    ...
    steps: [
      {
        ...
        description: "Click 'Upload Resume' button and either upload a file (PDF, DOC, DOCX) or paste your resume text directly.",
      ...
      },
      {
        ...
        description: "Provide a descriptive name for your resume to help you identify it later (e.g., 'Software Engineer Resume v2').",
        tip: "Use clear, descriptive names especially if you maintain multiple resume versions for different roles."
      },
      {
        step: 3,
        title: "Review and Save",
        description: "Review the extracted content to ensure accuracy, then save your resume to the system.",
        tip: "Check that key skills, experience, and contact information were extracted correctly."
      },
      {
        step: 4,
        title: "Manage Your Resumes",
        description: "View all uploaded resumes in the table, edit details, download files, or delete outdated versions.",
    ...
    troubleshooting: [
      {
        ...
        solution: "Check your internet connection and try again. Ensure file size is under 10MB and format is PDF, DOC, or DOCX."
      },
      {
        problem: "Text extraction looks incorrect",
        solution: "This can happen with complex formatting. Try uploading a simpler formatted version or paste the text directly."
      },
      {
        problem: "Cannot download resume file",
        solution: "Ensure you have permission to download files and your browser allows downloads from this site."
      }
    ],
  ...
  jobDescriptions: {
    ...
    description: "Learn how to create, manage, and optimize job descriptions for effective resume matching.",
    overview: "Job descriptions are essential for ATS analysis as they define the requirements and keywords that resumes are matched against. You can upload job postings or create custom descriptions with company and location details.",
    keyFeatures: [
    ...
    steps: [
      {
        ...
        description: "Click 'Create Job Description' and provide a clear title that describes the role (e.g., 'Senior Software Engineer - Frontend').",
        tip: "Use specific, descriptive titles that clearly indicate the role level and specialization."
      },
      {
        step: 2,
        title: "Add Company Information",
        description: "Enter the company name and other relevant details to provide context for the position.",
      ...
      },
      {
        ...
        description: "Add location information including city, state/province, and country if relevant to the position.",
        tip: "Location can be important for remote work preferences and regional skill requirements."
      },
      {
        step: 4,
        title: "Add Job Content",
        description: "Either upload a job posting file or paste the job description text, including requirements, responsibilities, and qualifications.",
        tip: "Include both required and preferred qualifications for more comprehensive matching analysis."
      },
      {
        step: 5,
        title: "Review and Save",
        description: "Review all information for accuracy and completeness before saving the job description.",
    ...
    troubleshooting: [
      {
        ...
        solution: "Try copying and pasting the text directly instead of uploading a file, or use a simpler text format."
      },
      {
        problem: "Search function not finding my job descriptions", 
        solution: "Check your search terms and try searching by company name or partial job titles."
      },
      {
  ...
  atsAnalysis: {
    id: "atsAnalysis",
    title: "ATS Analysis", 
    description: "Understand how to run ATS analyses, interpret results, and improve your resume compatibility scores.",
    overview: "ATS Analysis compares your resume against job descriptions to calculate compatibility scores, identify matched and missing skills, and provide improvement suggestions. This helps optimize your resume for specific positions.",
    keyFeatures: [
    ...
    steps: [
      {
        ...
        description: "Click 'New Analysis' and select both a resume and job description from your uploaded content.",
        tip: "Choose the most relevant resume version for the specific job you're targeting."
      },
      {
        step: 2,
        title: "Monitor Analysis Progress", 
        description: "Watch the progress indicator as the system processes your resume and job description for compatibility.",
      ...
      },
      {
        ...
        description: "Once complete, review your ATS compatibility score (0-100%). Scores above 80% indicate strong matches.",
      ...
      },
      {
        ...
        description: "Review the green-highlighted matched skills to see what strengths were identified in your resume.",
        tip: "Matched skills show what's working well - consider emphasizing these areas in interviews."
      },
      {
        step: 5,
        title: "Address Missing Skills",
        description: "Examine red-highlighted missing skills to identify areas for resume improvement or skill development.",
      ...
      },
      {
        ...
        description: "Read and implement the AI-generated suggestions to improve your resume for better compatibility.",
    ...
    troubleshooting: [
      {
        ...
        solution: "Wait up to 2 minutes for processing to complete. If still stuck, use the retry button or contact support."
      },
      {
        problem: "Score seems too low despite good qualifications",
        solution: "Check if your resume uses different terminology than the job description. Try incorporating exact keywords from the posting."
      },
      {
        problem: "Missing skills include things I have experience with",
        solution: "Ensure these skills are explicitly mentioned in your resume text. ATS systems look for exact keyword matches."
      },
      {
        problem: "Analysis shows error status",
        solution: "Use the retry button to reprocess the analysis. If errors persist, check that your resume and job description contain sufficient text content."
      }
    ],
  ...
  profileSettings: {
    ...
    description: "Learn how to configure your profile, manage account settings, and customize your Smart ATS experience.",
    overview: "Your profile settings control how the system knows about you and your preferences. Complete profile information can improve analysis quality and helps customize recommendations to your career level and goals.",
    keyFeatures: [
    ...
    steps: [
      {
        ...
        description: "Fill in your first name, last name, and email address to ensure proper account identification.",
        tip: "Use your professional email address for consistency across job applications."
      },
      {
        step: 2,
        title: "Add Contact Details",
        description: "Include phone number and location information to help with location-based job matching.",
      ...
      },
      {
        ...
        description: "Add a brief professional summary that describes your career focus and key qualifications.",
      ...
      },
      {
        ...
        description: "Add your LinkedIn URL and portfolio website to provide additional context about your professional presence.",
        tip: "Professional links help validate your experience and can provide additional keywords for analysis."
      },
      {
        step: 5,
        title: "Configure Preferences",
        description: "Set up notification preferences and other account settings to customize your experience.",
        tip: "Notification settings will help you stay informed about completed analyses and system updates when available."
      },
      {
        step: 6,
        title: "Review Security Settings",
        description: "Manage password, two-factor authentication, and other security features to protect your account.",
    ...
    troubleshooting: [
      {
        ...
        solution: "Check that all required fields are filled and email format is valid. Try refreshing the page and attempting again."
      },
      {
        problem: "LinkedIn or portfolio URL not accepting",
        solution: "Ensure URLs include https:// and are formatted correctly. Test the links in a browser to verify they work."
      },
      {
        problem: "Profile information not appearing in analyses",
        solution: "Profile information provides context but doesn't directly affect analysis. The main factors are resume content and job description matching."
      }
    ],
